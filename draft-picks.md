# Plunk Cup — Draft Pick Ownership (2026 Draft)

Future draft-pick ownership. Source: Yahoo **Grid View** (18 rounds, 8 teams),
plus one manual commissioner trade not reflected in Yahoo.

Default: each owner keeps their own pick every round. Table below lists only picks that changed hands.
...
|------:|----------------|--------------|--------|
| 3 | Jared | Padula | Yahoo trade (Aug 29, 2026) |
...
### Paul
- Extra: R5 (from Devin), R12 (from Lucas), R16 (from Padula)
- Missing: R7 (→ Lucas), R10 (→ Padula), R18 (→ Devin)
- **2 picks in R5, R12, R16; none in R7, R10, R18**

### Kervin
- Extra: R7 (from Zach), R15 (from Zach)
- Missing: R4 (→ Zach), R9 (→ Zach)
...
### Jared
- Extra: R18 (from Zach/manual), R8 (from Lucas/manual), R11 (from Padula)
- Missing: R4 (→ Zach/manual), R6 (→ Lucas/manual), R3 (→ Padula)
